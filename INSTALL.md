...
The links below point at the current version (v0.2.3); if a newer version
...
- Apple Silicon: [Arete-Monitor-0.2.3-arm64.dmg](https://github.com/project-arete/arete-monitor/releases/download/v0.2.3/Arete-Monitor-0.2.3-arm64.dmg)
- Intel: [Arete-Monitor-0.2.3-x64.dmg](https://github.com/project-arete/arete-monitor/releases/download/v0.2.3/Arete-Monitor-0.2.3-x64.dmg)
...
[Arete-Monitor-Setup-0.2.3.exe](https://github.com/project-arete/arete-monitor/releases/download/v0.2.3/Arete-Monitor-Setup-0.2.3.exe)
...
1. Download the file for your machine:
   - Regular PC (x86_64): [Arete-Monitor-0.2.3-x86_64.AppImage](https://github.com/project-arete/arete-monitor/releases/download/v0.2.3/Arete-Monitor-0.2.3-x86_64.AppImage)
   - ARM (e.g. Raspberry Pi 5 with a 64-bit desktop): [Arete-Monitor-0.2.3-arm64.AppImage](https://github.com/project-arete/arete-monitor/releases/download/v0.2.3/Arete-Monitor-0.2.3-arm64.AppImage)
...
1. Download: [amd64 (regular PC)](https://github.com/project-arete/arete-monitor/releases/download/v0.2.3/Arete-Monitor-0.2.3-amd64.deb)
   or [arm64](https://github.com/project-arete/arete-monitor/releases/download/v0.2.3/Arete-Monitor-0.2.3-arm64.deb)
2. Double-click it to open your software installer, or in a terminal:
   `sudo apt install ./Arete-Monitor-0.2.3-amd64.deb`
